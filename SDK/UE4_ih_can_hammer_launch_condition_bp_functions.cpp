...
#include "UE4_ih_can_hammer_launch_condition_bp_parameters.hpp"
...
bool Uih_can_hammer_launch_condition_bp_C::CanTransition(class AArchonCharacter** Character, class AArchonWeapon** Weapon, struct FComboInputBuffer* ComboInputBuffer)
{
	static auto fn = UObject::FindObject<UFunction>("Function ih_can_hammer_launch_condition_bp.ih_can_hammer_launch_condition_bp_C.CanTransition");

	Uih_can_hammer_launch_condition_bp_C_CanTransition_Params params;
