...
#include "UE4_badge_harvester_parameters.hpp"
...
void Abadge_harvester_C::GetSpecificBadgeScore(class Aplayer_state_bp_C** PlayerState, bool* HitBadgeThreshold, float* ImpressivenessScore, TEnumAsByte<Ebadge_elite_status>* EliteLevel)
{
	static auto fn = UObject::FindObject<UFunction>("Function badge_harvester.badge_harvester_C.GetSpecificBadgeScore");

	Abadge_harvester_C_GetSpecificBadgeScore_Params params;
...
void Abadge_harvester_C::UserConstructionScript()
{
	static auto fn = UObject::FindObject<UFunction>("Function badge_harvester.badge_harvester_C.UserConstructionScript");

	Abadge_harvester_C_UserConstructionScript_Params params;
