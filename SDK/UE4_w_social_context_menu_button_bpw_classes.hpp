...
#include "UE4_w_social_context_menu_button_bpw_structs.hpp"
...
// WidgetBlueprintGeneratedClass w_social_context_menu_button_bpw.w_social_context_menu_button_bpw_C
// 0x0040 (0x0310 - 0x02D0)
class Uw_social_context_menu_button_bpw_C : public UUserWidget
{
public:
	...
	struct FScriptMulticastDelegate                    Button_Clicked;                                           // 0x0300(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass w_social_context_menu_button_bpw.w_social_context_menu_button_bpw_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_w_social_context_menu_button_bpw(int EntryPoint);
