...
#include "UE4_w_play_menu_details_expedition_bpw_structs.hpp"
...
// WidgetBlueprintGeneratedClass w_play_menu_details_expedition_bpw.w_play_menu_details_expedition_bpw_C
// 0x0018 (0x0300 - 0x02E8)
class Uw_play_menu_details_expedition_bpw_C : public Uw_play_menu_details_base_bpw_C
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x02E8(0x0008) (Transient, DuplicateTransient)
	class UTextBlock*                                  TextBlock_Title;                                          // 0x02F0(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass w_play_menu_details_expedition_bpw.w_play_menu_details_expedition_bpw_C");
		return ptr;
	}
	...
	void Refresh();
	void Construct();
	void ExecuteUbergraph_w_play_menu_details_expedition_bpw(int EntryPoint);
};
