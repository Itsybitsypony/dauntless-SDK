...
#include "UE4_MaxComboX_parameters.hpp"
...
bool UMaxComboX_C::CanTransition(class AArchonCharacter** Character, class AArchonWeapon** Weapon, struct FComboInputBuffer* ComboInputBuffer)
{
	static auto fn = UObject::FindObject<UFunction>("Function MaxComboX.MaxComboX_C.CanTransition");

	UMaxComboX_C_CanTransition_Params params;
