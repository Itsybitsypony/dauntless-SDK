...
#include "UE4_LevelSequence_structs.hpp"
...
{
public:
	struct FLevelSequencePlayerSnapshot                FrameInformation;                                         // 0x02D0(0x0050) (BlueprintVisible, BlueprintReadOnly)
	class ALevelSequenceActor*                         LevelSequenceActor;                                       // 0x0320(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bCameraControlEnabled;                                    // 0x0800(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x47];                                      // 0x0801(0x0047) MISSED OFFSET
	TArray<class UObject*>                             AdditionalEventReceivers;                                 // 0x0848(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0x58];                                      // 0x0858(0x0058) MISSED OFFSET
	...
	class AActor* GetLevelSequenceActor();
