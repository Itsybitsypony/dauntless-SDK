...
#include "UE4_has_ammo_ec_parameters.hpp"
...
// Function has_ammo_ec.has_ammo_ec_C.CanTransition
...
bool Uhas_ammo_ec_C::CanTransition(class AArchonCharacter** Character, class AArchonWeapon** Weapon, struct FComboInputBuffer* ComboInputBuffer)
{
	static auto fn = UObject::FindObject<UFunction>("Function has_ammo_ec.has_ammo_ec_C.CanTransition");

	Uhas_ammo_ec_C_CanTransition_Params params;
