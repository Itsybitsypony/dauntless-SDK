...
#include "UE4_lantern_basic_03_hanging_bp_structs.hpp"
...
// BlueprintGeneratedClass lantern_basic_03_hanging_bp.lantern_basic_03_hanging_bp_C
// 0x0038 (0x03C0 - 0x0388)
class Alantern_basic_03_hanging_bp_C : public AActor
{
public:
	...
	float                                              Timeline_0_intensity_E3CB28364A155E3CED2EDE8E0DF0ECAD;    // 0x03B0(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    Timeline_0__Direction_E3CB28364A155E3CED2EDE8E0DF0ECAD;   // 0x03B4(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass lantern_basic_03_hanging_bp.lantern_basic_03_hanging_bp_C");
		return ptr;
	}
	...
	void startflicker();
	void ExecuteUbergraph_lantern_basic_03_hanging_bp(int EntryPoint);
};
