...
#include "UE4_BP_AoE_Lantern_Rocks_classes.hpp"
...
struct ABP_AoE_Lantern_Rocks_C_UserConstructionScript_Params
{
};

// Function BP_AoE_Lantern_Rocks.BP_AoE_Lantern_Rocks_C.ReceiveTick
struct ABP_AoE_Lantern_Rocks_C_ReceiveTick_Params
{
	float*                                             DeltaSeconds;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_AoE_Lantern_Rocks.BP_AoE_Lantern_Rocks_C.ExecuteUbergraph_BP_AoE_Lantern_Rocks
struct ABP_AoE_Lantern_Rocks_C_ExecuteUbergraph_BP_AoE_Lantern_Rocks_Params
{
