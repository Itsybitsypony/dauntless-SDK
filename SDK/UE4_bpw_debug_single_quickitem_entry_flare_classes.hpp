...
#include "UE4_bpw_debug_single_quickitem_entry_flare_structs.hpp"
...
// WidgetBlueprintGeneratedClass bpw_debug_single_quickitem_entry_flare.bpw_debug_single_quickitem_entry_flare_C
// 0x001C (0x02EC - 0x02D0)
class Ubpw_debug_single_quickitem_entry_flare_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass bpw_debug_single_quickitem_entry_flare.bpw_debug_single_quickitem_entry_flare_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_bpw_debug_single_quickitem_entry_flare(int EntryPoint);
};
