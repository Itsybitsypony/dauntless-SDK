...
#include "UE4_cblade_push_ec_parameters.hpp"
...
bool Ucblade_push_ec_C::CanTransition(class AArchonCharacter** Character, class AArchonWeapon** Weapon, struct FComboInputBuffer* ComboInputBuffer)
{
	static auto fn = UObject::FindObject<UFunction>("Function cblade_push_ec.cblade_push_ec_C.CanTransition");

	Ucblade_push_ec_C_CanTransition_Params params;
