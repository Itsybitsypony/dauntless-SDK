...
#include "UE4_GameplayAbilities_structs.hpp"
...
// 0x14A0 (0x16F0 - 0x0250)
class UAbilitySystemComponent : public UGameplayTasksComponent
{
public:
	TArray<struct FAttributeDefaults>                  DefaultStartingData;                                      // 0x0250(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<class UAttributeSet*>                       SpawnedAttributes;                                        // 0x0260(0x0010) (ExportObject, Net, ZeroConstructor)
	unsigned char                                      UnknownData00[0x280];                                     // 0x0270(0x0280) MISSED OFFSET
	float                                              OutgoingDuration;                                         // 0x04F0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              IncomingDuration;                                         // 0x04F4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x28];                                      // 0x04F8(0x0028) MISSED OFFSET
	TArray<class FString>                              ClientDebugStrings;                                       // 0x0520(0x0010) (Net, ZeroConstructor)
	TArray<class FString>                              ServerDebugStrings;                                       // 0x0530(0x0010) (Net, ZeroConstructor)
	struct FGameplayAbilitySpecContainer               ActivatableAbilities;                                     // 0x0540(0x00C8) (BlueprintVisible, BlueprintReadOnly, Net)
	unsigned char                                      UnknownData02[0x50];                                      // 0x0608(0x0050) MISSED OFFSET
	TArray<class UGameplayAbility*>                    AllReplicatedInstancedAbilities;                          // 0x0658(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x3F8];                                     // 0x0668(0x03F8) MISSED OFFSET
	TArray<class AGameplayAbilityTargetActor*>         SpawnedTargetActors;                                      // 0x0A60(0x0010) (ZeroConstructor)
	struct FGameplayAbilityRepAnimMontage              RepAnimMontageInfo;                                       // 0x0A70(0x0030) (Net)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0AA0(0x0008) MISSED OFFSET
	struct FGameplayAbilityLocalAnimMontage            LocalAnimMontageInfo;                                     // 0x0AA8(0x0030)
	unsigned char                                      UnknownData05[0x118];                                     // 0x0AD8(0x0118) MISSED OFFSET
	class AActor*                                      OwnerActor;                                               // 0x0BF0(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	class AActor*                                      AvatarActor;                                              // 0x0BF8(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x20];                                      // 0x0C00(0x0020) MISSED OFFSET
	struct FActiveGameplayEffectsContainer             ActiveGameplayEffects;                                    // 0x0C20(0x04F0) (Net)
	struct FActiveGameplayCueContainer                 ActiveGameplayCues;                                       // 0x1110(0x00D0) (Net)
	struct FActiveGameplayCueContainer                 MinimalReplicationGameplayCues;                           // 0x11E0(0x00D0) (Net)
	unsigned char                                      UnknownData07[0x180];                                     // 0x12B0(0x0180) MISSED OFFSET
	TArray<unsigned char>                              BlockedAbilityBindings;                                   // 0x1430(0x0010) (Net, ZeroConstructor, Transient)
	unsigned char                                      UnknownData08[0x180];                                     // 0x1440(0x0180) MISSED OFFSET
	struct FMinimalReplicationTagCountMap              MinimalReplicationTags;                                   // 0x15C0(0x0060) (Net)
	unsigned char                                      UnknownData09[0x10];                                      // 0x1620(0x0010) MISSED OFFSET
	struct FReplicatedPredictionKeyMap                 ReplicatedPredictionKeyMap;                               // 0x1630(0x00C0) (Net)
	...
	void ClientPrintDebug_Response(TArray<class FString> Strings, int GameFlags);
...
public:
	...
	unsigned char                                      UnknownData00[0x1A0];                                     // 0x01B0(0x01A0) MISSED OFFSET
	TArray<class UClass*>                              LoadedGameplayCueNotifyClasses;                           // 0x0350(0x0010) (ZeroConstructor, Transient)
	TArray<class AGameplayCueNotify_Actor*>            GameplayCueClassesForPreallocation;                       // 0x0360(0x0010) (ZeroConstructor, Transient)
	...
	unsigned char                                      UnknownData03[0x78];                                      // 0x03A8(0x0078) MISSED OFFSET
...
public:
	...
	struct FGameplayTagReferenceHelper                 ReferenceHelper;                                          // 0x03A0(0x0040) (Edit)
	struct FName                                       GameplayCueName;                                          // 0x03E0(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bAutoAttachToOwner;                                       // 0x03E8(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IsOverride;                                               // 0x03E9(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUniqueInstancePerInstigator;                             // 0x03EA(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUniqueInstancePerSourceObject;                           // 0x03EB(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowMultipleOnActiveEvents;                             // 0x03EC(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowMultipleWhileActiveEvents;                          // 0x03ED(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x03EE(0x0002) MISSED OFFSET
	int                                                NumPreallocatedInstances;                                 // 0x03F0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3C];                                      // 0x03F4(0x003C) MISSED OFFSET
...
public:
	...
	struct FGameplayEffectModifierMagnitude            DurationMagnitude;                                        // 0x0038(0x01B8) (Edit, DisableEditOnInstance)
	struct FScalableFloat                              Period;                                                   // 0x01F0(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	bool                                               bExecutePeriodicEffectOnApplication;                      // 0x0218(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0219(0x0007) MISSED OFFSET
	TArray<struct FGameplayModifierInfo>               Modifiers;                                                // 0x0220(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	TArray<struct FGameplayEffectExecutionDefinition>  Executions;                                               // 0x0230(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	struct FScalableFloat                              ChanceToApplyToTarget;                                    // 0x0240(0x0028) (Edit, DisableEditOnInstance)
	TArray<class UClass*>                              ApplicationRequirements;                                  // 0x0268(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	TArray<class UClass*>                              TargetEffectClasses;                                      // 0x0278(0x0010) (ZeroConstructor, Deprecated)
	TArray<struct FConditionalGameplayEffect>          ConditionalGameplayEffects;                               // 0x0288(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	TArray<class UClass*>                              OverflowEffects;                                          // 0x0298(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	bool                                               bDenyOverflowApplication;                                 // 0x02A8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bClearStackOnOverflow;                                    // 0x02A9(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x6];                                       // 0x02AA(0x0006) MISSED OFFSET
	TArray<class UClass*>                              PrematureExpirationEffectClasses;                         // 0x02B0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	TArray<class UClass*>                              RoutineExpirationEffectClasses;                           // 0x02C0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	bool                                               bRequireModifierSuccessToTriggerCues;                     // 0x02D0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bSuppressStackingCues;                                    // 0x02D1(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData04[0x6];                                       // 0x02D2(0x0006) MISSED OFFSET
	TArray<struct FGameplayEffectCue>                  GameplayCues;                                             // 0x02D8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	class UGameplayEffectUIData*                       UIData;                                                   // 0x02E8(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	struct FInheritedTagContainer                      InheritableGameplayEffectTags;                            // 0x02F0(0x0060) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FInheritedTagContainer                      InheritableOwnedTagsContainer;                            // 0x0350(0x0060) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FGameplayTagRequirements                    OngoingTagRequirements;                                   // 0x03B0(0x0040) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FGameplayTagRequirements                    ApplicationTagRequirements;                               // 0x03F0(0x0040) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FInheritedTagContainer                      RemoveGameplayEffectsWithTags;                            // 0x0430(0x0060) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FGameplayTagRequirements                    GrantedApplicationImmunityTags;                           // 0x0490(0x0040) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	...
	unsigned char                                      UnknownData05[0x1];                                       // 0x0640(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0x5];                                       // 0x064B(0x0005) MISSED OFFSET
...
// Class GameplayAbilities.GameplayAbilityMontageCallback
// 0x0028 (0x0050 - 0x0028)
class UGameplayAbilityMontageCallback : public UObject
{
public:
	TWeakObjectPtr<class UAbilitySystemComponent>      AbilitySystemComponent;                                   // 0x0028(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<struct FActiveGameplayEffectHandle>         AppliedEffects;                                           // 0x0030(0x0010) (ZeroConstructor)
	struct FScriptDelegate                             Delegate;                                                 // 0x0040(0x0014) (ZeroConstructor, InstancedReference)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class GameplayAbilities.GameplayAbilityMontageCallback");
		return ptr;
	}
...
public:
	...
	TArray<class FString>                              GameplayCueNotifyPaths;                                   // 0x01C8(0x0010) (ZeroConstructor, Config)
...
public:
	...
	float CalculateBaseMagnitude(const struct FActiveGameplayEffectHandle& ActiveEffect, const struct FGameplayEffectSpec& Spec);
};
...
public:
	...
	struct FGameplayEffectContextHandle STATIC_EffectContextSetHitDirection(const struct FGameplayEffectContextHandle& EffectContext, const struct FVector& HitDirection);
	...
	struct FVector STATIC_EffectContextGetHitDirection(const struct FGameplayEffectContextHandle& EffectContext);
