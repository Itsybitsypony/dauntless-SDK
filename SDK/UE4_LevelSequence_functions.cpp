...
#include "UE4_LevelSequence_parameters.hpp"
...
// Function LevelSequence.LevelSequencePlayer.GetLevelSequenceActor
// (Native, Public, BlueprintCallable)
// Parameters:
// class AActor*                  ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

class AActor* ULevelSequencePlayer::GetLevelSequenceActor()
{
	static auto fn = UObject::FindObject<UFunction>("Function LevelSequence.LevelSequencePlayer.GetLevelSequenceActor");

	ULevelSequencePlayer_GetLevelSequenceActor_Params params;
