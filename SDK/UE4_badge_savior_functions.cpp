...
#include "UE4_badge_savior_parameters.hpp"
...
void Abadge_savior_C::GetSpecificBadgeScore(class Aplayer_state_bp_C** PlayerState, bool* HitBadgeThreshold, float* ImpressivenessScore, TEnumAsByte<Ebadge_elite_status>* EliteLevel)
{
	static auto fn = UObject::FindObject<UFunction>("Function badge_savior.badge_savior_C.GetSpecificBadgeScore");

	Abadge_savior_C_GetSpecificBadgeScore_Params params;
...
void Abadge_savior_C::UserConstructionScript()
{
	static auto fn = UObject::FindObject<UFunction>("Function badge_savior.badge_savior_C.UserConstructionScript");

	Abadge_savior_C_UserConstructionScript_Params params;
