...
#include "UE4_PacketHandler_classes.hpp"
...
enum class ENetworkFailure : uint8_t
{
	...
	ENetworkFailure__ClientConnectionTimeout = 4,
	ENetworkFailure__ServerConnectionTimeout = 5,
	ENetworkFailure__FailureReceived = 6,
	ENetworkFailure__OutdatedClient = 7,
	ENetworkFailure__OutdatedServer = 8,
	ENetworkFailure__PendingConnectionFailure = 9,
	ENetworkFailure__NetGuidMismatch = 10,
	ENetworkFailure__NetChecksumMismatch = 11,
	ENetworkFailure__ENetworkFailure_MAX = 12
};
...
// Enum Engine.EArchonGender
enum class EArchonGender : uint8_t
{
	EArchonGender__Neutral         = 0,
	EArchonGender__Masculine       = 1,
	EArchonGender__Feminine        = 2,
	EArchonGender__Mixed           = 3,
	EArchonGender__Unspecified     = 4,
	EArchonGender__EArchonGender_MAX = 5
};


// Enum Engine.EArchonBodyType
enum class EArchonBodyType : uint8_t
{
	EArchonBodyType__Unspecified   = 0,
	EArchonBodyType__Masculine     = 1,
	EArchonBodyType__Feminine      = 2,
	EArchonBodyType__EArchonBodyType_MAX = 3
};
...
// Enum Engine.EMontageBlendInPose
enum class EMontageBlendInPose : uint8_t
{
	EMontageBlendInPose__EBIP_OutgoingMontage = 0,
	EMontageBlendInPose__EBIP_IncomingMontage = 1,
	EMontageBlendInPose__EBIP_MAX  = 2
};
...
// Enum Engine.EActionKeyMappingType
enum class EActionKeyMappingType : uint8_t
{
	EActionKeyMappingType__AMT_PrimaryKey = 0,
	EActionKeyMappingType__AMT_SecondaryKey = 1,
	EActionKeyMappingType__AMT_Gamepad = 2,
	EActionKeyMappingType__AMT_MAX = 3
};
...
enum class ETextureGroup : uint8_t
{
	...
	TEXTUREGROUP_PHX_CharacterDye  = 30,
	TEXTUREGROUP_PHX_WorldMedium   = 31,
	TEXTUREGROUP_PHX_WorldMediumNormalMap = 32,
	TEXTUREGROUP_PHX_WorldSmall    = 33,
	TEXTUREGROUP_PHX_WorldSmallNormalMap = 34,
	TEXTUREGROUP_PHX_Armour        = 35,
	TEXTUREGROUP_PHX_ArmourNormalMap = 36,
	TEXTUREGROUP_PHX_ArmourSpecular = 37,
	TEXTUREGROUP_PHX_Monster       = 38,
	TEXTUREGROUP_PHX_MonsterNormalMap = 39,
	TEXTUREGROUP_PHX_MonsterSpecular = 40,
	TEXTUREGROUP_MAX               = 41
};
...
struct FHitResult
{
	...
	unsigned char                                      bComponentRelativeLocationSet : 1;                        // 0x0000(0x0001)
	...
	struct FVector_NetQuantize                         ComponentRelativeLocation;                                // 0x0018(0x000C)
	struct FVector_NetQuantize                         ImpactPoint;                                              // 0x0024(0x000C)
	struct FVector_NetQuantizeNormal                   Normal;                                                   // 0x0030(0x000C)
	struct FVector_NetQuantizeNormal                   ImpactNormal;                                             // 0x003C(0x000C)
	struct FVector_NetQuantize                         TraceStart;                                               // 0x0048(0x000C)
	struct FVector_NetQuantize                         TraceEnd;                                                 // 0x0054(0x000C)
	float                                              PenetrationDepth;                                         // 0x0060(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Item;                                                     // 0x0064(0x0004) (ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class UPhysicalMaterial>            PhysMaterial;                                             // 0x0068(0x0008) (ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class AActor>                       Actor;                                                    // 0x0070(0x0008) (ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class UPrimitiveComponent>          Component;                                                // 0x0078(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
struct FInputActionKeyMapping
{
	...
	unsigned char                                      bCanRebind : 1;                                           // 0x0020(0x0001) (Edit, BlueprintVisible)
	EActionKeyMappingType                              ActionMappingType;                                        // 0x0021(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FInputAxisKeyMapping
{
	...
	EActionKeyMappingType                              AxisMappingType;                                          // 0x0024(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0025(0x0003) MISSED OFFSET
};

// ScriptStruct Engine.InputActionKeyMappingRemoval
// 0x0010
struct FInputActionKeyMappingRemoval
{
	struct FName                                       ActionName;                                               // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EActionKeyMappingType                              ActionMappingType;                                        // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FSkeletalMeshLODInfo
{
	...
	class FString                                      SourceImportFilename;                                     // 0x00B0(0x0010) (Edit, ZeroConstructor, EditConst)
...
// ScriptStruct Engine.CurveDefaultValue
// 0x0010
struct FCurveDefaultValue
{
	struct FName                                       Name;                                                     // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Value;                                                    // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
...
struct FAnimMontageInstance
{
	...
	class UAnimInstance*                               CustomBlendInGraphAnimInstance;                           // 0x0058(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x28];                                      // 0x0060(0x0028) MISSED OFFSET
	TArray<int>                                        NextSections;                                             // 0x0088(0x0010) (ZeroConstructor)
	TArray<int>                                        PrevSections;                                             // 0x0098(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData04[0x10];                                      // 0x00A8(0x0010) MISSED OFFSET
	TArray<struct FAnimNotifyEvent>                    ActiveStateBranchingPoints;                               // 0x00B8(0x0010) (ZeroConstructor, Transient)
	float                                              Position;                                                 // 0x00C8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x00CC(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAlphaBlend                                 Blend;                                                    // 0x00D0(0x0038) (Transient)
	unsigned char                                      UnknownData05[0x24];                                      // 0x0108(0x0024) MISSED OFFSET
	int                                                DisableRootMotionCount;                                   // 0x012C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData06[0x20];                                      // 0x0130(0x0020) MISSED OFFSET
};
...
// ScriptStruct Engine.AnimNode_MontageBlendInPoseEvaluator
// 0x0040 (0x0070 - 0x0030)
struct FAnimNode_MontageBlendInPoseEvaluator : public FAnimNode_Base
{
	TEnumAsByte<EMontageBlendInPose>                   Source;                                                   // 0x0030(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3F];                                      // 0x0031(0x003F) MISSED OFFSET
};

// ScriptStruct Engine.AnimNode_MontageBlendInResult
// 0x0020 (0x0050 - 0x0030)
struct FAnimNode_MontageBlendInResult : public FAnimNode_Base
{
	struct FPoseLink                                   Result;                                                   // 0x0030(0x0018) (Edit, BlueprintVisible)
	float                                              BlendAlpha;                                               // 0x0048(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x004C(0x0004) MISSED OFFSET
};
...
struct FBPVariableDescription
{
	...
	uint64_t                                           PropertyFlags;                                            // 0x00A8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FName                                       RepNotifyFunc;                                            // 0x00B0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ELifetimeCondition>                    ReplicationCondition;                                     // 0x00B8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FMeshBuildSettings
{
	...
	float                                              VolumeAOContrast;                                         // 0x0040(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bGenerateVolumeGIVoxels;                                  // 0x0044(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0045(0x0003) MISSED OFFSET
	int                                                VolumeGIVoxelResolution;                                  // 0x0048(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FMeshSectionInfo
{
	...
	bool                                               bGenerateShell;                                           // 0x0006(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x0007(0x0001) MISSED OFFSET
	float                                              ShellThickness;                                           // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsGeneratedShell;                                        // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	float                                              VolumeAOTranslucency;                                     // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	struct FMeshBuildSettings                          BuildSettings;                                            // 0x0000(0x0050) (Edit)
	struct FMeshReductionSettings                      ReductionSettings;                                        // 0x0050(0x0024) (Edit)
	float                                              LODDistance;                                              // 0x0074(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              ScreenSize;                                               // 0x0078(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
