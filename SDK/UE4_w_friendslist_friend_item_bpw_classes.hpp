...
#include "UE4_w_friendslist_friend_item_bpw_structs.hpp"
...
// WidgetBlueprintGeneratedClass w_friendslist_friend_item_bpw.w_friendslist_friend_item_bpw_C
// 0x02C0 (0x0590 - 0x02D0)
class Uw_friendslist_friend_item_bpw_C : public UUserWidget
{
public:
	...
	class UNamedSlot*                                  InfoWidgetSlot;                                           // 0x02F0(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	class Usocial_menu_friends_item_inner_bpw_C*       social_menu_context_header_bpw;                           // 0x02F8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass w_friendslist_friend_item_bpw.w_friendslist_friend_item_bpw_C");
		return ptr;
	}
	...
	void ButtonClick();
	void ExecuteUbergraph_w_friendslist_friend_item_bpw(int EntryPoint);
