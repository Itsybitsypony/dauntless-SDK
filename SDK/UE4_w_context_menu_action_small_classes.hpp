...
#include "UE4_w_context_menu_action_small_structs.hpp"
...
// WidgetBlueprintGeneratedClass w_context_menu_action_small.w_context_menu_action_small_C
// 0x0074 (0x03B0 - 0x033C)
class Uw_context_menu_action_small_C : public Uw_context_menu_action_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass w_context_menu_action_small.w_context_menu_action_small_C");
		return ptr;
	}
	...
	void Construct();
	void Handle_Action();
	void ExecuteUbergraph_w_context_menu_action_small(int EntryPoint);
};
