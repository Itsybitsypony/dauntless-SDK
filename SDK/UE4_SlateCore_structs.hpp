...
enum class ESlateBrushDrawType : uint8_t
{
	...
	ESlateBrushDrawType__Outline   = 4,
...
// Enum SlateCore.EInputScheme
enum class EInputScheme : uint8_t
{
	EInputScheme__MouseKeyboard    = 0,
	EInputScheme__Gamepad          = 1,
	EInputScheme__KeyboardNavigation = 2,
	EInputScheme__EInputScheme_MAX = 3
};
...
// Enum SlateCore.EGamepadScrolling
enum class EGamepadScrolling : uint8_t
{
	EGamepadScrolling__None        = 0,
	EGamepadScrolling__RightStick  = 1,
	EGamepadScrolling__LeftStick   = 2,
	EGamepadScrolling__EGamepadScrolling_MAX = 3
};
...
// ScriptStruct SlateCore.FocusButtonStyle
// 0x03E0 (0x03E8 - 0x0008)
struct FFocusButtonStyle : public FSlateWidgetStyle
{
	struct FSlateBrush                                 Normal;                                                   // 0x0008(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 Hovered;                                                  // 0x0098(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 Selected;                                                 // 0x0128(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 Focused;                                                  // 0x01B8(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 Pressed;                                                  // 0x0248(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 Disabled;                                                 // 0x02D8(0x0090) (Edit, BlueprintVisible)
	struct FLinearColor                                NormalColor;                                              // 0x0368(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                HoveredColor;                                             // 0x0378(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                SelectedColor;                                            // 0x0388(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                FocusedColor;                                             // 0x0398(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                PressedColor;                                             // 0x03A8(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                DisabledColor;                                            // 0x03B8(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FMargin                                     NormalPadding;                                            // 0x03C8(0x0010) (Edit, BlueprintVisible)
	struct FMargin                                     PressedPadding;                                           // 0x03D8(0x0010) (Edit, BlueprintVisible)
};
