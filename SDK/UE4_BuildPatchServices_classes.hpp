...
#include "UE4_BuildPatchServices_structs.hpp"
...
public:
	...
	class FString                                      PrereqName;                                               // 0x0070(0x0010) (ZeroConstructor)
	class FString                                      PrereqPath;                                               // 0x0080(0x0010) (ZeroConstructor)
	class FString                                      PrereqArgs;                                               // 0x0090(0x0010) (ZeroConstructor)
