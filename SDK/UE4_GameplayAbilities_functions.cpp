...
#include "UE4_GameplayAbilities_parameters.hpp"
...
// (Net, NetReliable, Native, Event, Public, NetServer, NetValidate)
// Parameters:
// TArray<class FString>          Strings                        (ConstParm, Parm, ZeroConstructor, ReferenceParm)
...
void UAbilitySystemComponent::ClientPrintDebug_Response(TArray<class FString> Strings, int GameFlags)
{
...
// (Native, Event, Public, HasOutParms, BlueprintEvent, Const)
// Parameters:
// struct FActiveGameplayEffectHandle ActiveEffect                   (Parm)
// struct FGameplayEffectSpec     Spec                           (ConstParm, Parm, OutParm, ReferenceParm)
// float                          ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

float UGameplayModMagnitudeCalculation::CalculateBaseMagnitude(const struct FActiveGameplayEffectHandle& ActiveEffect, const struct FGameplayEffectSpec& Spec)
{
	...
	params.ActiveEffect = ActiveEffect;
	params.Spec = Spec;
...
// Function GameplayAbilities.AbilitySystemBlueprintLibrary.EffectContextSetHitDirection
// (Final, Native, Static, Public, HasDefaults, BlueprintCallable, BlueprintPure)
// Parameters:
// struct FGameplayEffectContextHandle EffectContext                  (Parm)
...
struct FGameplayEffectContextHandle UAbilitySystemBlueprintLibrary::STATIC_EffectContextSetHitDirection(const struct FGameplayEffectContextHandle& EffectContext, const struct FVector& HitDirection)
{
	static auto fn = UObject::FindObject<UFunction>("Function GameplayAbilities.AbilitySystemBlueprintLibrary.EffectContextSetHitDirection");

	UAbilitySystemBlueprintLibrary_EffectContextSetHitDirection_Params params;
	params.EffectContext = EffectContext;
...
// Function GameplayAbilities.AbilitySystemBlueprintLibrary.EffectContextGetHitDirection
// (Final, Native, Static, Public, HasDefaults, BlueprintCallable, BlueprintPure)
// Parameters:
// struct FGameplayEffectContextHandle EffectContext                  (Parm)
// struct FVector                 ReturnValue                    (Parm, OutParm, ReturnParm, IsPlainOldData)

struct FVector UAbilitySystemBlueprintLibrary::STATIC_EffectContextGetHitDirection(const struct FGameplayEffectContextHandle& EffectContext)
{
	static auto fn = UObject::FindObject<UFunction>("Function GameplayAbilities.AbilitySystemBlueprintLibrary.EffectContextGetHitDirection");

	UAbilitySystemBlueprintLibrary_EffectContextGetHitDirection_Params params;
	params.EffectContext = EffectContext;
