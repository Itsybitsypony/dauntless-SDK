...
#include "UE4_CableComponent_parameters.hpp"
...
// Function CableComponent.CableComponent.SendDynamicData
// (Final, Native, Public, BlueprintCallable)

void UCableComponent::SendDynamicData()
{
	static auto fn = UObject::FindObject<UFunction>("Function CableComponent.CableComponent.SendDynamicData");

	UCableComponent_SendDynamicData_Params params;
