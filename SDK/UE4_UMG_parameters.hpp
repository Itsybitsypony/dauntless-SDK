...
struct UWidget_SetUserFocusWithCause_Params
{
...
struct UUserWidget_ShouldRestoreFocusToWidget_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct UUserWidget_OnSynchronizeProperties_Params
{
};
...
struct UUserWidget_OnKeyUpFallback_Params
{
...
struct UUserWidget_OnKeyDownFallback_Params
{
	struct FGeometry                                   MyGeometry;                                               // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	struct FKeyEvent                                   InKeyEvent;                                               // (ConstParm, Parm, OutParm, ReferenceParm)
	struct FEventReply                                 ReturnValue;                                              // (Parm, OutParm, ReturnParm)
...
struct UWidgetBlueprintLibrary_PreventUserFocusChange_Params
{
	struct FEventReply                                 Reply;                                                    // (Parm, OutParm, ReferenceParm)
	struct FEventReply                                 ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
...
struct UWidgetBlueprintLibrary_GetFocusCause_Params
{
