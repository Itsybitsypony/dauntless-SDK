...
#include "UE4_badge_unyielding_parameters.hpp"
...
void Abadge_unyielding_C::GetSpecificBadgeScore(class Aplayer_state_bp_C** PlayerState, bool* HitBadgeThreshold, float* ImpressivenessScore, TEnumAsByte<Ebadge_elite_status>* EliteLevel)
{
	static auto fn = UObject::FindObject<UFunction>("Function badge_unyielding.badge_unyielding_C.GetSpecificBadgeScore");

	Abadge_unyielding_C_GetSpecificBadgeScore_Params params;
...
void Abadge_unyielding_C::UserConstructionScript()
{
	static auto fn = UObject::FindObject<UFunction>("Function badge_unyielding.badge_unyielding_C.UserConstructionScript");

	Abadge_unyielding_C_UserConstructionScript_Params params;
