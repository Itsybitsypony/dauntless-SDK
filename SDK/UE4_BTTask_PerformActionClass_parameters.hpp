...
#include "UE4_BTTask_PerformActionClass_classes.hpp"
...
struct UBTTask_PerformActionClass_C_ReceiveExecuteAI_Params
{
...
struct UBTTask_PerformActionClass_C_ReceiveTickAI_Params
{
	class AAIController**                              OwnerController;                                          // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	class APawn**                                      ControlledPawn;                                           // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
struct UBTTask_PerformActionClass_C_ReceiveAbortAI_Params
{
	class AAIController**                              OwnerController;                                          // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	class APawn**                                      ControlledPawn;                                           // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UBTTask_PerformActionClass_C_ExecuteUbergraph_BTTask_PerformActionClass_Params
{
