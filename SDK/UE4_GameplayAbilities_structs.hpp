...
#include "UE4_GameplayTasks_classes.hpp"
...
struct FGameplayAbilitySpec : public FFastArraySerializerItem
{
	...
	unsigned char                                      bRespondOnHeld : 1;                                       // 0x0029(0x0001) (RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
...
{
	class FString                                      AttributeName;                                            // 0x0000(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst)
...
struct FActiveGameplayEffect : public FFastArraySerializerItem
{
	...
	unsigned char                                      UnknownData01[0x17B];                                     // 0x02D5(0x017B) MISSED OFFSET
};
...
struct FGameplayEffectQuery
{
	...
	struct FScriptDelegate                             CustomMatchDelegate_BP;                                   // 0x0040(0x0014) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
...
{
	TArray<class FString>                              Paths;                                                    // 0x0000(0x0010) (ZeroConstructor)
...
struct FGameplayEffectModifierMagnitude
{
	...
	struct FSetByCallerFloat                           SetByCallerMagnitude;                                     // 0x01A8(0x0010) (Edit, DisableEditOnInstance)
};
...
struct FGameplayModifierInfo
{
	...
	struct FGameplayEffectModifierMagnitude            ModifierMagnitude;                                        // 0x0050(0x01B8) (Edit, DisableEditOnInstance)
...
struct FGameplayEffectExecutionScopedModifierInfo
{
	...
	struct FGameplayEffectModifierMagnitude            ModifierMagnitude;                                        // 0x0030(0x01B8) (Edit, DisableEditOnInstance)
	struct FGameplayModEvaluationChannelSettings       EvaluationChannelSettings;                                // 0x01E8(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData01[0x7];                                       // 0x01E9(0x0007) MISSED OFFSET
	struct FGameplayTagRequirements                    SourceTags;                                               // 0x01F0(0x0040) (Edit, DisableEditOnInstance)
	struct FGameplayTagRequirements                    TargetTags;                                               // 0x0230(0x0040) (Edit, DisableEditOnInstance)
};
...
struct FAttributeMetaData : public FTableRowBase
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0014(0x0004) MISSED OFFSET
	class FString                                      DerivedAttributeInfo;                                     // 0x0018(0x0010) (ZeroConstructor)
