...
#include "UE4_OculusHMD_structs.hpp"
...
{
public:
	class UStaticMesh*                                 ControllerMesh;                                           // 0x03E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnOuterBoundaryTriggered;                                 // 0x01D0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnOuterBoundaryReturned;                                  // 0x01E0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
