...
#include "UE4_bttask_enter_tired_state_structs.hpp"
...
// BlueprintGeneratedClass bttask_enter_tired_state.bttask_enter_tired_state_C
// 0x0021 (0x00C1 - 0x00A0)
class Ubttask_enter_tired_state_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass bttask_enter_tired_state.bttask_enter_tired_state_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_bttask_enter_tired_state(int EntryPoint);
};
