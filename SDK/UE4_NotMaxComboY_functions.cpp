...
#include "UE4_NotMaxComboY_parameters.hpp"
...
bool UNotMaxComboY_C::CanTransition(class AArchonCharacter** Character, class AArchonWeapon** Weapon, struct FComboInputBuffer* ComboInputBuffer)
{
	static auto fn = UObject::FindObject<UFunction>("Function NotMaxComboY.NotMaxComboY_C.CanTransition");

	UNotMaxComboY_C_CanTransition_Params params;
