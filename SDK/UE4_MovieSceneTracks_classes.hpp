...
#include "UE4_MovieSceneTracks_structs.hpp"
...
public:
	...
	TArray<class FString>                              ActorGuidStrings;                                         // 0x0198(0x0010) (ZeroConstructor)
...
public:
	...
	class FString                                      TargetSequenceName;                                       // 0x0158(0x0010) (Edit, ZeroConstructor)
