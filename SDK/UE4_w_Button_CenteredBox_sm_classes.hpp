...
#include "UE4_w_Button_CenteredBox_sm_structs.hpp"
...
// WidgetBlueprintGeneratedClass w_Button_CenteredBox_sm.w_Button_CenteredBox_sm_C
// 0x0058 (0x0328 - 0x02D0)
class Uw_Button_CenteredBox_sm_C : public UUserWidget
{
public:
	...
	class UImage*                                      Hover_Test;                                               // 0x02E8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	bool                                               Button_In_Focus;                                          // 0x0310(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0311(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    Button_Clicked;                                           // 0x0318(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass w_Button_CenteredBox_sm.w_Button_CenteredBox_sm_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_w_Button_CenteredBox_sm(int EntryPoint);
