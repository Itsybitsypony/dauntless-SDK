...
#include "UE4_w_npc_interact_redeem_quest_bpw_structs.hpp"
...
class Uw_npc_interact_redeem_quest_bpw_C : public UArchonUserWidget
{
public:
	...
	bool                                               RedeemInFlight;                                           // 0x0328(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	TArray<class UQuestEventData*>                     RedeemEvents;                                             // 0x0340(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass w_npc_interact_redeem_quest_bpw.w_npc_interact_redeem_quest_bpw_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_w_npc_interact_redeem_quest_bpw(int EntryPoint);
};
