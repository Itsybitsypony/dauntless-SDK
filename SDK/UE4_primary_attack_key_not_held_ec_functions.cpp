...
#include "UE4_primary_attack_key_not_held_ec_parameters.hpp"
...
bool Uprimary_attack_key_not_held_ec_C::CanTransition(class AArchonCharacter** Character, class AArchonWeapon** Weapon, struct FComboInputBuffer* ComboInputBuffer)
{
	static auto fn = UObject::FindObject<UFunction>("Function primary_attack_key_not_held_ec.primary_attack_key_not_held_ec_C.CanTransition");

	Uprimary_attack_key_not_held_ec_C_CanTransition_Params params;
