...
#include "UE4_badge_control_parameters.hpp"
...
void Abadge_control_C::GetSpecificBadgeScore(class Aplayer_state_bp_C** PlayerState, bool* HitBadgeThreshold, float* ImpressivenessScore, TEnumAsByte<Ebadge_elite_status>* EliteLevel)
{
	static auto fn = UObject::FindObject<UFunction>("Function badge_control.badge_control_C.GetSpecificBadgeScore");

	Abadge_control_C_GetSpecificBadgeScore_Params params;
...
void Abadge_control_C::UserConstructionScript()
{
	static auto fn = UObject::FindObject<UFunction>("Function badge_control.badge_control_C.UserConstructionScript");

	Abadge_control_C_UserConstructionScript_Params params;
