...
#include "UE4_AIModule_parameters.hpp"
...
// TArray<struct FEnvNamedValue>  QueryParams                    (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
// class UEnvQueryInstanceBlueprintWrapper* ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

class UEnvQueryInstanceBlueprintWrapper* UEnvQueryManager::STATIC_RunEQSQuery(class UObject* WorldContextObject, class UEnvQuery* QueryTemplate, class UObject* Querier, TEnumAsByte<EEnvQueryRunMode> RunMode, class UClass* WrapperClass, TArray<struct FEnvNamedValue> QueryParams)
{
