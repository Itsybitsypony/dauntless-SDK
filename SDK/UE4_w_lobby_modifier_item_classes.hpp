...
#include "UE4_w_lobby_modifier_item_structs.hpp"
...
class Uw_lobby_modifier_item_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass w_lobby_modifier_item.w_lobby_modifier_item_C");
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_w_lobby_modifier_item(int EntryPoint);
};
