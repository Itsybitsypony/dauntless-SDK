...
#include "UE4_havestamina_condition_bp_parameters.hpp"
...
bool Uhavestamina_condition_bp_C::CanTransition(class AArchonCharacter** Character, class AArchonWeapon** Weapon, struct FComboInputBuffer* ComboInputBuffer)
{
	static auto fn = UObject::FindObject<UFunction>("Function havestamina_condition_bp.havestamina_condition_bp_C.CanTransition");

	Uhavestamina_condition_bp_C_CanTransition_Params params;
