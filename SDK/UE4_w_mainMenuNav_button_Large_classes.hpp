...
#include "UE4_w_mainMenuNav_button_Large_structs.hpp"
...
// WidgetBlueprintGeneratedClass w_mainMenuNav_button_Large.w_mainMenuNav_button_Large_C
// 0x0048 (0x0318 - 0x02D0)
class Uw_mainMenuNav_button_Large_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass w_mainMenuNav_button_Large.w_mainMenuNav_button_Large_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_w_mainMenuNav_button_Large(int EntryPoint);
