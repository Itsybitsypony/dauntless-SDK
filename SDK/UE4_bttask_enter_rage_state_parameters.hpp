...
#include "UE4_bttask_enter_rage_state_classes.hpp"
...
struct Ubttask_enter_rage_state_C_ReceiveExecuteAI_Params
{
...
struct Ubttask_enter_rage_state_C_ReceiveAbortAI_Params
{
	class AAIController**                              OwnerController;                                          // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	class APawn**                                      ControlledPawn;                                           // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct Ubttask_enter_rage_state_C_TriggerEnterRageAudioEvent_Params
{
};

// Function bttask_enter_rage_state.bttask_enter_rage_state_C.ExecuteUbergraph_bttask_enter_rage_state
struct Ubttask_enter_rage_state_C_ExecuteUbergraph_bttask_enter_rage_state_Params
{
